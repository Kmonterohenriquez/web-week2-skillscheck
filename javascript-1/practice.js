...
// Code Here
const doubled= myNumbers.map((curr)=> curr *2);
...
// Code Here
const filtered= myNumbers.filter((curr)=> curr > 100);
...
// Code Here
const total = myNumbers.reduce((acc, curr)=> acc + curr);
...
myNumbers.forEach((curr, i)=> myNumbersIndex.push(i));
...
// Code Here
const forTheLoveOfGeorge= notGeorge.map((curr, i)=> notGeorge[i] = 'George');
//////////////////PROBLEM 19////////////////////
